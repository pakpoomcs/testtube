      ...
      <div style={styles.hero}>
        <div style={styles.heroInner}>
          ...
          <p style={styles.heroSub}>
            Practice tests for IELTS, TOEIC, ONET, TCAS and more — with instant
            feedback and personalised reports.
          </p>
        </div>
        ...
        {filtered.map((exam) => (
          <div
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 12px 32px rgba(0,194,168,0.15)";
            }}
            onMouseLeave={(e) => {
          ...
          >
            ...
            <div style={styles.cardBody}>
              ...
              {/* Thai name */}
              {exam.name_th && <p style={styles.examNameTh}>{exam.name_th}</p>}
              ...
              {(() => {
                ...
                return (
                  <button
                    style={
                      isPremium ? styles.buttonPremium : styles.buttonStart
                    }
